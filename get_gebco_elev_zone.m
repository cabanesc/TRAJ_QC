...
if (isempty(a_gebcoFileName))
   %a_gebcoFileName = '/home/pharos/andro/livraisons/Livraison_0712021/soft/DecArgo_soft/_ressources/GEBCO_2020/GEBCO_2020.nc';
    a_gebcoFileName = [DIR_BATHY 'GEBCO_2020.nc'];
end
