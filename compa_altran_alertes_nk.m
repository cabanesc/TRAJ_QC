...
%liste_rep_alerte = {'AOML_RISER_apex_argos'; 'JMA_APEX_PI_JAMSTEC'; 'CSIRO_APEX_argos_apf9'; ...
%    'CSIRO_APEX_argos_apf8'; 'INCOIS_APEX_Argos_apf8'; 'INCOIS_APEX_Argos_apf9'; ...
%    'AOML_SOLOII_Dmode_all'; 'AOML_SOLOII_Dmode_all_bis'};

%liste_rep_alerte = {'AOML_RISER_apex_argos'; 'JMA_APEX_PI_JAMSTEC'; 'CSIRO_APEX_argos_apf9'; ...
%    'CSIRO_APEX_argos_apf8'; 'INCOIS_APEX_Argos_apf8'; 'INCOIS_APEX_Argos_apf9'; ...
%   'AOML_SOLOII_Dmode_all_bis'};

%liste_rep_alerte = {'CSIRO_APEX_argos_apf9'; ...
%    'CSIRO_APEX_argos_apf8'; 'INCOIS_APEX_Argos_apf8'};

liste_rep_alerte = {'CSIRO_APEX_argos_apf9'};

liste_alertes = {'grounded';'pressure';'locpos';'locdate';'cycle';'locterre';'launchdate'; ...
    'metadur'};

%liste_alertes = {'pressure';'locpos';'locdate';'cycle';'locterre';'launchdate'; ...
%    'metadur'};
%liste_alertes = {'cycle';'locterre';'launchdate'; ...
%    'metadur'};

%%%%Fichiers Altran
DIR = '/home/gherbert/andro/andro/soft/listes/Liste_livraison2019/';
...
for l = 1:length(liste_rep_alerte)     %%%  boucle sur les types de flotteurs
...
nb_flot=[];
     ...
     title({'Pourcentage de Flotteurs identiques à Altran' ...
          liste_rep_alerte{l}});
     titre1 = ['Nbre de Flotteurs identiques(b), supplémentaires(g), manquants(y)']
...
%     Namefig = ['/home/gherbert/Images/compa_test_altran/compa_par_type/flot_id_supp_miss_' liste_rep_alerte{l} 'pourverif2.png'];
     Namefig = ['./figures/flot_id_supp_miss_' liste_rep_alerte{l} 'pourverif2.png'];
     saveas(gcf,Namefig)
     ...
     xticklabels(alerte_str)
     xtickangle(45)
     titre1 = ['Nbre de cycles identiques(b), supplémentaires(g), manquants(y)']
     titre2 = ['pour un flotteur présent dans les deux cas'];
...
%     Namefig = ['/home/gherbert/Images/compa_test_altran/compa_par_type/Cyc_id_supp_miss_' liste_rep_alerte{l} 'pourverif2.png'];
     Namefig = ['./figures/Cyc_id_supp_miss_' liste_rep_alerte{l} 'pourverif2.png'];
     saveas(gcf,Namefig)
...
%     Namefig = ['/home/gherbert/Images/compa_test_altran/compa_par_type/Nb_flot_' liste_rep_alerte{l} 'pourverif2.png'];
     Namefig = ['./figures/Nb_flot_' liste_rep_alerte{l} 'pourverif2.png'];
     saveas(gcf,Namefig)
 ...
 fch_1 = ['./alerts/alerte_grounded_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_2 = ['./alerts/alerte_press_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_3 = ['./alerts/alerte_locpos_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_4 = ['./alerts/alerte_locdate_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_5 = ['./alerts/alerte_cycle_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_6 = ['./alerts/alerte_locterre_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_7 = ['./alerts/alerte_launchdate_missing_2_' liste_rep_alerte{l} '.txt'];
 fch_8 = ['./alerts/alerte_metadur_missing_2_' liste_rep_alerte{l} '.txt'];
...
%%%%   ------------------------------------------------------------------
%%%% Figure alertes pour l'ensemble des types de floteurs. (attention pour la premi!ère erreur de la liste seulement)
...
%    'pour un flotteur présent dans les deux cas'});
grid on
Namefig = ['/home/gherbert/Images/compa_test_altran/compa_par_type/Cyc_id_supp_miss_all2.png'];
saveas(gcf,Namefig)
