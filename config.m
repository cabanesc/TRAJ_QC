...
param.DIR_LISTE = '/home/pharos/andro/soft/listes/';
...
param.Liste_Float = [param.DIR_LISTE 'Liste_livraison2019/32_80_CSIRO_APEX_argos_apf8.txt'];
%param.Liste_Float = [param.DIR_LISTE 'Liste_livraison2019/32_80_CSIRO_APEX_argos_apf8_erreur_grounded.txt'];
...
%param.Liste_Float = [param.DIR_LISTE 'Liste_livraison2019/2_172_AOML_RISER_apex_argos_erreur_pressure_test.txt'],
end
